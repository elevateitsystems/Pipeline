  ...
  return (
    <div className="">
      ...
      <header className="">
        ...
        <div className="audit-content-padding flex items-center justify-between my-1">
          <Skeleton
            width={120}
            height={28}
            baseColor="#e5e7eb"
      ...
      <main className="audit-content-padding pt-5 bg-white pb-48">
            ...
            <div className="space-y-0">
              {Array.from({ length: 10 }).map((_, index) => (
                <div key={index} className="flex border-b border-gray-300">
                  <div className="audit-index-col border-r border-gray-300 px-4 py-3 flex items-center justify-center">
                    <Skeleton width={20} height={20} circle />
                  </div>
                  <div className="audit-question-col border-r border-gray-300 px-4 py-3 flex-1">
                    <Skeleton
                      height={40}
                      className="rounded-xl"
                      baseColor="#e5e7eb"
                  ...
                  <div className="audit-answer-col border-r border-gray-300 px-4 py-3 flex-1">
                    <div className="flex gap-2 items-center justify-center">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <div key={i} className="audit-status-button">
                          <Skeleton
                            height={36}
